                        ...
                        <div className="detail-table-wrap">
                            <div className="table-adj">
                                <div className="table-responsive">                                
                                    <div className="adj-title-name flex-wrap">{this.state.imageData_name[key]}</div>  
                                    <table className="detail-table-custom"> {/* table table-sm table-borderless  */}
                                        <colgroup>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <th className="w-40" scope="row">Owner</th>
                                                {/* <td>{this.state.owners[key]}</td> */}
                                                <td>{this.state.owners[key]}</td>
                                            </tr>
                                            <tr>
                                                <th className="w-40" scope="row">Token ID</th>
                                                <td>{this.state.imageData_token[key]}</td>
                                            </tr>
                                            <tr>
                                                <th className="w-40" scope="row">Url</th>
                                                <td>{this.state.imageData_url[key]}</td>
                                            </tr>
                                            <tr>
                                                <th className="w-40" scope="row">Description</th>
                                        ...
                                        (
                                            <form onSubmit={(event) => {
                                                ...
                                                <div className="price-etk-wrap d-flex">
                                                    <div className="etk-title">Price in ETK</div> {/**pric */}
                                                    <input
                                                        type='text'
                                ...
                                <div className="mx-2 submit-btn-box">
                                    {
                                        (this.state.approved[key] && (process.env.REACT_APP_ACCOUNT !== this.state.account)) ?
                                            ...
                                            /> */}
                                                    <button type="submit" className='btn submit-btn btn-primary text-dark'>
                            ...
                            <div className="detail-action mt-4">
                                ...
                                <div className="tb-tab-wrap d-flex">
                                    ...
                                    <span className="tb-tab">Price in ETK</span> {/* 필요시 활성화 */}
                                </div>
                                <table className="table table-sm table-borderless bid-history-tb">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src={coinImg} className="bid-icon" alt="name-img" /><span className="bid-name">Lorem</span><span className="pl-bid">placed a bid</span>
                                                <span className="history-time">1 day ago</span></td>
                                            <td><span className="eth-price"><img alt="main" className="eth-class" src={coinImg} />230.00</span>
                                                <span className="eth-dolor">&#36; 245.00</span></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img src={coinImg}className="bid-icon" alt="name-img" /><span className="bid-name">Inpum</span><span className="pl-bid">placed a bid</span>
                                                <span className="history-time">1 day ago</span></td>
                                            <td><span className="eth-price"><img alt="main" className="eth-class" src={coinImg} />110.00</span>
                                                <span className="eth-dolor">&#36; 100.00</span></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img src={coinImg}className="bid-icon" alt="name-img" /><span className="bid-name">Dolor</span><span className="pl-bid">placed a bid</span>
                                                <span className="history-time">1 day ago</span></td>
                                            <td><span className="eth-price"><img alt="main" className="eth-class" src={coinImg} />123.00</span>
                                                <span className="eth-dolor">&#36; 122.00</span></td>
                                        </tr>
                                ...
                                <table className="table table-sm table-borderless hide-tb">  {/* 필요시 활성화 */}
                                </table>
                            </div>
                        </div>
                    </div>
