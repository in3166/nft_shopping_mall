  ...
  async loadBlockchainData() {
    ...
    if (this.state.token_sale_contract) {
      if (sale_networkData) {
        ...
        window.alert("Smart contract not deployed to detected network.1");
      }
      ...
      if (token_networkData) {
        ...
        window.alert("Smart contract not deployed to detected network.2");
      }
      ...
      if (token_sale_networkData) {
        ...
        window.alert("Smart contract not deployed to detected network.3");
      }
              ...
              <div className="d-flex justify-content-center align-items-center my-1">
                ...
                process.env.REACT_APP_TEMP_ACCOUNT !== this.state.account ? (
                  <div className="text-danger">
                    {"This NFT is not Approved by Owner"}
                  </div>
                ) : null}
              </div>
            </div>
