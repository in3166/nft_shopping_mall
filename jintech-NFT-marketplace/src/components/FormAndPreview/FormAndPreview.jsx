...
//    var client = create('http://jtsol.iptime.org:5001/api/v0');
    ...
    //const urlStr = `https://ipfs.jtsol.com/ipfs/${cid}`;
    const urlStr = `ipfs://${cid}/${this.state.filename}`
                ...
                <form className="row text-end" onSubmit={(event) => {
                  ...
                  <div className="col-6">
                    <input
                      ...
                      onChange={event => this.setState({ new_image: event.target.files[0], filename:event.target.files[0].name })}
                    />
                  </div>
                  <div className="col-6">
                    <input
