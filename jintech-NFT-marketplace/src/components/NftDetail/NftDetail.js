        ...
        if (networkData) {
            ...
            for (i = 1; i <= totalSupply; i++) {
                ...
                this.setState({
                    ...
                    imageData_url: [...this.state.imageData_url, metadata.image],
                        ...
                        <div className="d-flex justify-content-around">
                            ...
                            <div className="col-8">
                                ...
                                <div className="d-flex justify-content-center align-items-center my-1">
                                    {
                                        ((this.state.owner != null) && (this.state.owners === process.env.REACT_APP_ACCOUNT)) ?
                                            (
                                    ...
                                    <div className="mx-2">
                                        {
                                            ...
                                            /> */}
                                                        <button type="submit" className='btn btn-block btn-primary rounded-0 text-dark'>
                                                            {"Buy - " + (this.state.imageData_price * this.state.token_price)}
